...
#Survival Rates: A striking 62.1% of passengers did not survive the Titanic disaster, surpassing the 37.9% who did survive.

#Class Disparity: Our analysis reveals that passengers in the 3rd class were disproportionately affected, with a significantly higher mortality rate compared to those in the 1st and 2nd classes.

#Age Neutrality: Contrary to expectations, our study finds that age did not play a significant role in determining survival rates, with passengers of all ages equally likely to perish or survive.

#Gender Dynamics: The data suggests that men were disproportionately represented among those who did not survive, likely due to the chivalrous practice of prioritizing women and children in the evacuation process.

#Traveling Alone: Interestingly, our analysis indicates that passengers who were traveling alone were more likely to survive the disaster, possibly due to their increased mobility and ability to respond quickly to the emergency.
